...
export default function SignupPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success('Registration Successful! Please check your email to confirm.', { duration: 5000 });
            router.push('/');
        ...
        <div className="min-h-screen w-full flex items-center justify-center bg-[#0f0c29] bg-gradient-to-br from-[#0f0c29] via-[#302b63] to-[#24243e] relative overflow-hidden font-sans">
            ...
            <div className="relative w-full max-w-md p-8 mx-4 bg-white/10 backdrop-blur-2xl border border-white/20 rounded-3xl shadow-2xl z-10">
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                    ...
                    {/* Name Input (Supabase Auth primarily uses email/pw, but we can store name in metadata later or separate table) */}
                    <div className="space-y-1.5">
                        <label htmlFor="name" className="text-xs font-medium text-white/80 uppercase tracking-wider ml-1">Full Name</label>
                    ...
                    {/* Password Input */}
                    <div className="space-y-1.5">
                        <label htmlFor="password" className="text-xs font-medium text-white/80 uppercase tracking-wider ml-1">Password</label>
                        <div className="relative group">
                            <input
                                type="password"
                                id="password"
                ...
                <div className="my-6 flex items-center gap-3">
                    ...
                    <span className="text-white/40 text-xs font-medium">OR SIGN UP WITH</span>
                    <div className="h-px bg-white/10 flex-1" />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <button
                        ...
                        className="flex items-center justify-center gap-2 px-4 py-2.5 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl transition-all duration-200 group"
                    >
                    ...
                    <button type="button" className="flex items-center justify-center gap-2 px-4 py-2.5 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl transition-all duration-200 group">
